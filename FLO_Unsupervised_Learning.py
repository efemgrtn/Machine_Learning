...
# Veriyi Hazırlama
           # 1. flo_data_20K.csv.csv verisini okuyalım.
           # 2. Müşterileri segmentlerken kullanacağımız değişkenleri seçelim. Tenure(Müşterinin yaşı), Recency (en son kaç gün önce alışveriş yaptığı) gibi yeni değişkenler oluşturabiliriz.

# K-Means ile Müşteri Segmentasyonu
           # 1. Değişkenleri standartlaştıralım.
           # 2. Optimum küme sayısını belirleyelim.
           # 3. Modelimizi oluşturalım ve müşterilerimizi segmentleyelim.
           # 4. Herbir segmenti istatistiksel olarak inceleyeniz.

# Hierarchical Clustering ile Müşteri Segmentasyonu
           # 1. Standırlaştırdığımız dataframe'i kullanarak optimum küme sayısını belirleyelim.
           # 2. Modelimizi oluşturalım ve müşterilerimizi segmentleyelim.
           # 3. Herbir segmenti istatistiksel olarak inceleyeniz.


###############################################################
# Veri setini okutalım ve müşterileri segmentlerken kullanıcağımız değişkenleri seçelim.
###############################################################
...
# Standarlaştırdığımız dataframe'i kullanarak optimum küme sayısını belirleyelim.
...
# 2. Modelimizi oluşturalım ve müşterilerimiz segmentleyelim.
