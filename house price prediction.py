...
# Elimizdeki veri seti üzerinden minimum hata ile ev fiyatlarını tahmin eden bir makine öğrenmesi modeli geliştirelim ve kaggle yarışmasına tahminlerelimi yükleyelim.
...
######################################
# Veri setine EDA işlemlerini uygulayalım.
######################################
...
################################################################
# Adım 1: Train ve Test veri setlerini okutup birleştirelim. Birleştirdiğimiz veri üzerinden ilerleyelim.
################################################################
...
######################################
# Rare analizi yapalım ve rare encoder uygulayalım.
######################################
...
######################################
# eni değişkenler oluşturalım ve oluşturduğumuz yeni değişkenlerin başına 'NEW' ekleyelim.
######################################
...
##################
# Label Encoding & One-Hot Encoding işlemlerini uygulayalım.
##################
...
#  Train ve Test verisini ayıralım. (SalePrice değişkeni boş olan değerler test verisidir.)
...
##################
# BONUS : Log dönüşümü yaparak model kuralım ve rmse sonuçlarını gözlemleyelim.
# Not: Log'un tersini (inverse) almayı unutmayalım.
##################
...
########################################
# test dataframeindeki boş olan salePrice değişkenlerini tahminleyelim ve
